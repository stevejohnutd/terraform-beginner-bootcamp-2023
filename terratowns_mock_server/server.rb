...
# We wil mock have a state or database for this development server by setting a global variable.
...
class TerraTownsMockServer < Sinatra::Base
  ...
  def x_user_uuid
    return '9a92407d-a511-40ef-a6bf-44e615cf0e03'
  end
  ...
  post '/api/u/:user_uuid/homes' do
    ...
    begin
      # Sinatra does not automatically part json bodys as params like rails so we need to manually parse it.
  ...
  put '/api/u/:user_uuid/homes/:uuid' do
    ...
    name = payload["name"]
    description = payload["description"]
    #domain_name = payload["domain_name"] - Not needed for Update
    content_version = payload["content_version"]
    ...
    home.name = name
    home.description = description
    #home.domain_name = domain_name - Not needed for update
    home.content_version = content_version
    # binding.pry
